...
def optimization_model_builder_mountain_car(PREDICTION_HORIZON, STATES_NUMBER, INPUTS_NUMBER, lower_bound_x, upper_bound_x, upper_bound_u, lower_bound_u, NUMBER_PWA_REGIONS, centers, M_state, m_state, lb_z_s_k, ub_z_s_k, M_input_policy, m_input_policy):
